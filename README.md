...
To install all of the plugins, open XCFixins.xcworkspace and build it, which automatically installs the plugins as a part of the build process. To install a plugin individually, open its respective project and build it.
